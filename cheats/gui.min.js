...
(() => {
        ...
        const guiWrapper = createElement("div", {
            ...
            (gui = createElement("div", {
                ...
                createElement("div", {
                    ...
                    onclick: () => window.open("https://gitlab.com/blooket-cheats/Blooket-Cheats", "_blank").focus()
                }),
    ...
    img.onload = function() {
        ...
        let _, time = 1710881112502, error = "There's a good chance these cheats don't work anymore. Make sure to join Skool's and 05Konz's Discord for updates. Run anyway?";
        try {
    ...
    img.onerror = img.onabort = () => {
        ...
        cheat();
        let iframe = document.querySelector("iframe");
        iframe.contentWindow.alert("If these cheats do not work, join the Discord servers below and let us know.\n05konz: https://discord.gg/jHjGrrdXP6\nSkool: https://discord.gg/skool-community-950407933408198717")
    }
})();